...
import { hasSectionScopedTrackActivationV2 } from './showBoundaryScopeV2'
...
function resolveShowV2CompileContext(
  ...
  if (!wholeOutput && composition.transitions.length > 0 && hasSectionScopedTrackActivationV2(record)) {
