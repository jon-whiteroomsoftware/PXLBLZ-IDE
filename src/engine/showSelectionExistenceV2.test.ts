...
describe('showSelectionExistsV2', () => {
  ...
  it('preserves Transition selections from the timeline id owners', () => {
    ...
    expect(showSelectionExistsV2(record, { kind: 'transition', transitionId: 'layout-cut:occurrence' })).toBe(true)
  })
