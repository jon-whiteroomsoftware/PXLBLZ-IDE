...
export const SHOW_COMMAND_V2_REFUSAL_CODES: ShowCommandV2RefusalCode[] = [
  ...
  { code: 'invalid-request', v1: null, meaning: 'A Layer, Zone or Layout definition intent carries a blank identity or name, or an inconsistent order.' },
  ...
  { code: 'unsupported-layout', v1: null, meaning: 'A Transition edit would leave a contributing Clip in a Zone the active Layout does not provide.' },
  ...
  { code: 'visual-transition-window', v1: null, meaning: 'Insert Time falls strictly inside a visual Transition window.' },
  { code: 'layout-transfer-window', v1: null, meaning: 'Insert Time falls strictly inside a timed Layout transfer.' },
  { code: 'transition-attachment', v1: null, meaning: 'The mapped candidate leaves a Transition detached from its participants.' },
  { code: 'property-mapping', v1: null, meaning: 'A Property track or its repeat-scale source curve cannot be mapped across the inserted time.' },
  { code: 'shared-track-conflict', v1: null, meaning: 'The mapped candidate overlaps an active owner track for the same target.' },
