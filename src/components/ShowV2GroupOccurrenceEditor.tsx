...
export function ShowV2GroupOccurrenceEditor({ capture, submitGroupOccurrenceEdit, isCurrentCapture, isCurrentCompletion, onStatus }: {
  ...
  const act = async (kind: Exclude<ShowV2GroupOccurrenceIntent['kind'], 'set-definition-clip-timing' | 'edit-definition-clip-appearance' | 'write-definition-instance-properties' | 'resize-definition-layer-transition' | 'insert-definition-layer-transition'>) => {
