import { agentBuiltinAccessRefusal, agentServiceRefusal, agentResponse, type AgentAccessEnvironment } from '../../cloudflare/agentAccess'
...
export async function resolveBuiltinConnection(
  ...
  if (!accountId || agentBuiltinAccessRefusal(accountId, env) || !env.AGENT_ACCOUNTS
