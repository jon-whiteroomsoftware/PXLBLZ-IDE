...
export const STOCK_MAP_SPECS: SourceMapSpec[] = [
  ...
  strandView({
    id: 'clustered-helical-mast-strand',
    familyId: 'clustered-helical-mast',
    familyName: 'Clustered helical mast',
    kind: 'path',
    positionSource: source('clustered-helical-mast-spatial'),
    displayDim: 3,
  }),
  {
    id: 'clustered-helical-mast-surface',
    name: 'Clustered helical mast · Surface',
    kind: 'path',
    dim: 2,
    displayDim: 3,
    source: source('clustered-helical-mast-surface'),
    positionSource: source('clustered-helical-mast-spatial'),
    family: {
      id: 'clustered-helical-mast',
      name: 'Clustered helical mast',
      view: 'surface',
      natural: true,
    },
  },
  {
    id: 'clustered-helical-mast-spatial',
    name: 'Clustered helical mast · Spatial',
    kind: 'path',
    dim: 3,
    source: source('clustered-helical-mast-spatial'),
    positionSource: source('clustered-helical-mast-spatial'),
    family: { id: 'clustered-helical-mast', name: 'Clustered helical mast', view: 'spatial' },
  },
  strandView({
