...
// Credit: "Oasis" by ZRanger1 - https://patterns.electromage.com/pattern/tDydtqqnzaRZYKjLx
// License: Redistributed with permission from ZRanger1.
//
// Four layered waves produce a calm, deep-water shimmer inspired by Pacifica.
// Runs on: 1D strips, rings, and strands.
// Controls: Hue — Shifts the water palette around the color wheel;
//           Speed — Sets the wave motion rate;
//           Whitecaps — Sets the brightness and frequency of wave crests;
//           Depth — Sets the contrast between deep water and highlights;
//           Wavelength — Sets the spatial scale of the layered waves.
