...
//
// Concentric grayscale rings breathe outward from the center on an exact
// loop. A Show ingredient for Luma and Chroma keying rather than a finished
...
//           loop advances exactly one ring;
//           Direction — Inward, hold, or outward travel;
//           Spacing — Ring-to-ring distance;
//           Width — Lit fraction of each ring cycle;
//           Feather — Edge softness, from hard rings to sine-smooth swells;
//           Lean — Ring asymmetry, from symmetric through full sawtooth,
...
// controls) evaluated over a phase geometry - here, radial distance from the
// frame center. Phase accumulates on its own clock, so animating any control
...
export function render2D(index, x, y) {
  var p = hypot(x - 0.5, y - 0.5) / pitch - phase
