...
// Credit: "Bouncer3D" by ZRanger1 - https://patterns.electromage.com/pattern/EhA8fr9WHBPTf92rZ
// License: Redistributed with permission from ZRanger1.
//
// Up to twenty colored balls move independently and bounce from the map boundaries.
// Runs on: 2D and 3D maps; the 3D renderer is selected when available.
// Controls: Balls — Sets the number of moving balls;
//           Size — Sets each ball's radius;
//           Speed — Sets the ball motion rate.
...
// Pixelblaze implicitly initializes globals to zero. Declare h so the browser
// preview preserves that behavior before the first pixel intersects a ball.
var h = 0;
