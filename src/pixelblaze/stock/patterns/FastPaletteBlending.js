// Pattern: Fast Palette Blending
// Built with PXLBLZ-IDE https://pxlblz-ide.whiteroomsoftware.com/
// Credit: "Fast Palette Blending" by ZRanger1 - https://patterns.electromage.com/pattern/jp7dq47XpcYq2JztT
// License: Redistributed with permission from ZRanger1.
//
// A palette manager demonstrates smooth transitions between FastLED gradient palettes.
...
function buildBlendedPalette(pal1, pal2, blend) {
  ...
  // Refresh Precise preview's decoded palette after mutating the source array.
  // Pixelblaze and Fast preview retain the array by reference, so this is a no-op
  // there and keeps the published palette behavior intact.
  setPalette(currentPalette);
}
