...
describe('demo smoke tests', () => {
  ...
  for (const file of ['PlasmaNebula.js', 'Caustics.js', 'KaleidoBloom.js', 'Kishimisu.js', 'PhantomStar.js', 'ShapeShifter.js', 'GlyphRain.js', 'Murmuration.js', 'Harmonograph.js', 'EventHorizon.js', 'ClockworkIris.js', 'SceneSplice.js', 'LumaStripes.js', 'LumaChevron.js', 'LumaRings.js', 'LumaPinwheel.js', 'LumaDots.js', 'LumaWeave.js', 'LumaSpiral.js']) {
