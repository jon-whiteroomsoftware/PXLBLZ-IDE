// Pattern: Doom Fire v2.0 2D
// Built with PXLBLZ-IDE https://pxlblz-ide.whiteroomsoftware.com/
// Credit: "Doom Fire (v2.0) 2D" by ZRanger1 - https://patterns.electromage.com/pattern/iQwYYKEYjnx4yFPZ5
// License: MIT License.
//
// A convolution fire simulation recreates the dramatic low-resolution PSX Doom flame.
// Runs on: 2D maps; authored for a 16 x 16 display.
// Controls: Hue — Sets the flame color;
//           Flame Height — Sets how far the fire rises;
//           Wind — Sets the horizontal flame drift;
//           Dragon Mode — Enables the enhanced dragon-breath rendering;
//           Speed — Sets the simulation update rate.
