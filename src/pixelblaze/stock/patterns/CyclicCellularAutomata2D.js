// Pattern: Cyclic Cellular Automata 2D
// Built with PXLBLZ-IDE https://pxlblz-ide.whiteroomsoftware.com/
// Credit: "Cyclic Cellular Automata 2D" by ZRanger1 - https://patterns.electromage.com/pattern/eCZZDTeyo8dukuWrw
// License: Redistributed with permission from ZRanger1.
//
// Configurable cyclic cellular automata grow excitable, fire-like fields.
// Runs on: 2D maps; designed for panels and mapped surfaces.
// Controls: Speed — Adjusts speed; Lifetime — Adjusts lifetime; Mode — Adjusts mode.
...
export function render2D(index, x, y) {
  x = clamp(floor(x * width), 0, width - 1);
