...
export interface AgentAccessEnvironment {
  ...
  /** Legacy deployment binding; built-in admission deliberately ignores it. */
...
export function agentBuiltinAccessRefusal(accountId: string, env: AgentAccessEnvironment): 'service_disabled' | null {
  void accountId
  return agentServiceRefusal(env)
}
