...
- the **embedding** control — owns `pos`; populated from the selected **map dimension**, not Pattern dimensionality: **shapes** for Index/1D, **surfaces** for 2D, and trivial (identity) for 3D. Present whenever there is a display choice to make.
