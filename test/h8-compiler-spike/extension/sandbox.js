// Sandboxed iframe — the MV3-legal eval host (the spike's actual unknown).
//
...
// compilePattern(src), builds the bytecode blob, and posts it back. If eval is
// blocked here, the spike is a NO-GO and push falls back to the Node bridge.
