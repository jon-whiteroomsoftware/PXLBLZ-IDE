...
| Bulk Clip/Layer authoring | Final-state collision admission, atomic property refusal, nested omission, shared-instance conflicts, and distinct-path summary deduplication |
