...
- `docs/IDE Technical Reference.md` §5 (fixed-point engine) and §11 (porting toolkit) — how Fidelity works as built and why the two divergences (numeric vs algorithmic) differ.
