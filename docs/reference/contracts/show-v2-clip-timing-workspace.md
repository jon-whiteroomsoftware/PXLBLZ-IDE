...
Authority: scene-retirement specification §§4–9/12, assigned ROUTE/FAILURE/SHARING/RESTART/CURVE/ACTIVATION/INSERT/GROUP-HOLD/LAYOUT-END proof subset. This workspace is additive under `?show-v2-pilot=1`; production-v1 activation is unchanged. The approved layout, supported partitions and limits are recorded in [the frontend contract](../evidence/issue-1038-clip-timing-workspace/frontend-contract.md).
