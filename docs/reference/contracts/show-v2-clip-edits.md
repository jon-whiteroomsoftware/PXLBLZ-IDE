...
Production v2 commands, the editor and persistence call its prepared-edit
adapters. The former preview route was removed by #1067 Stage 1; current
backing follows a stored v2 row or native v2 built-in, with no preview parameter.
