...
[L951 browser case](../../../../e2e/agent-baseline.auth.spec.ts) and
...
omit-shell fault failed the sparse-preservation regression; source was restored
...
The historical sparse fixture and materialized records were pruned in #994.
The [L951 browser case](../../../../e2e/agent-baseline.auth.spec.ts) asserts
complete sparse Layer preservation; the images establish the historical manual
operation. At source `982e10d2d194923414cdeee0358138be86a28c58`,
...
shared Group semantics; the retained images show the pre-repair evidence. A bounded
...
produced one adoption/save. [L951 browser case](../../../../e2e/agent-baseline.auth.spec.ts) and
...
The [source fixture builder](../../../../src/test/showOverlayLayerFixture.ts)
supplies the rich authored record used by the browser case; its sparse variant
clears Scene 2 overlays before export/reopen. Final committed-tip suites, native
review, landing and IAB
...
case `L951: command admission saves once, reopens, undoes, refuses stale and deduplicates`,
